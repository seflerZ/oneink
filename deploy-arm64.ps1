# OneInk - ARM64 Deploy Script
# Builds, copies to Program Files, and registers the COM AddIn

. "$PSScriptRoot\config.ps1"

$Platform = "ARM64"
$OutputPath = $Global:InstallPathARM64

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "OneInk - ARM64 Deployment" -ForegroundColor Cyan
Write-Host "========================================"
Write-Host

# 1. Build
Write-Host "[1/4] Building OneInk (ARM64)..." -ForegroundColor Yellow
